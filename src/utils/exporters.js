...
import html2canvas from "html2canvas-pro" // Change this import to use the pro version
...
export async function exportPDF(rootElementId, filename) {
  try {
    ...
    alert("Failed to export PDF. Please try again or check console for details.")
  }
}